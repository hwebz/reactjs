...
// If you're running the server locally, the URL will be, be default, localhost:3000
...
class KanbanBoardContainer extends Component {
    constructor() {
        ...
        this.updateCardPosition = throttle(this.updateCardPosition.bind(this), 500); //set to 0 -> will invoke func when arg changes. >0 -> will invoke func when arg changes or time up.
    }
    ...
    addCard(card) {
        ...
        .then((responseData) => {
            ...
            // used for the Card on the server, update it on React
    ...
    addTask(cardId, taskName) {
        ...
        // Call the API to add state to the mutated object
        ...
        .then((responseData) => {
            // When the server returns the definitive ID
            // used for the new Task on server, update it on React
